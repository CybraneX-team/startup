...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp shadow-two dark:shadow-three dark:hover:shadow-gray-dark hover:shadow-one dark:bg-dark rounded-sm  bg-white p-8 duration-300 dark:bg-slate-900 lg:px-5 xl:px-8"
        data-wow-delay=".1s"
      >
        ...
        <div className="flex items-center">
          <div className="relative mr-4 h-[50px] w-full max-w-[50px] overflow-hidden rounded-full">
            <Image src="/images/user/user-01.png" alt={name} fill />
          </div>
          <div className="w-full">
