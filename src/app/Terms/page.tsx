...
const Terms: React.FC = () => {
  return (
    <Providers>
      <div className="relative flex w-screen flex-col bg-[#FCFCFC] dark:bg-black overflow-hidden ">
        <Header />
        <main className="text-black dark:text-white min-h-screen mt-15 p-8 relative z-10">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl font-bold mb-6">Terms of Service</h1>
            <p className="text-sm text-gray-400 dark:text-gray-500 mb-4">Last updated: July 10, 2025</p>

            <h2 className="text-xl font-semibold mt-6 mb-2">1. Agreement to Terms</h2>
            <p>
              By accessing or using Unicorn Simulator, you agree to comply with and be bound by these Terms of Service.
              If you do not agree with any part of the terms, please do not use the platform.
            </p>
            ...
            <p>
              You are responsible for all actions taken through your account. Any misuse, manipulation, or abusive
              behavior may lead to account suspension or termination at our discretion.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">4. Changes to Terms</h2>
            <p>
              We may revise these Terms from time to time. Your continued use of Unicorn Simulator after changes
              are made indicates your acceptance of the updated Terms. We recommend reviewing them periodically.
            </p>
          </div>
        </main>
