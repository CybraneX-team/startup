...
const SignUp: React.FC = () => {
  ...
  const handleUserCreation = async (e: React.FormEvent)=>{
    ...
    const makeReq = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/auth/register`, {
      method: "POST",
      body: JSON.stringify(
        {
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-lg font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to Startup Simulator
              </h2>
